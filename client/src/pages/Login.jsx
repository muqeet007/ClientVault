        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 backdrop-blur-2xl rounded-2xl border border-gray-700 shadow-2xl overflow-hidden">
          ...
          <div className="p-4 sm:p-6 md:p-8">
            <div className="text-center mb-4 sm:mb-6">
              <h2 className="text-base sm:text-lg md:text-xl font-bold text-white">Login</h2>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <Mail
                    className={`absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 transition-colors ${
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-3 py-2 sm:py-3 bg-gray-900 border border-gray-700 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-orange-400 focus:border-orange-400 transition-all text-sm sm:text-base text-white placeholder-gray-500 hover:bg-gray-800"
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onBlur={() => setFocusedField('')}
                    required
                    className="w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-2 sm:py-3 bg-gray-900 border border-gray-700 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-orange-400 focus:border-orange-400 transition-all text-sm sm:text-base text-white placeholder-gray-500 hover:bg-gray-800"
            ...
            <div className="mt-4 sm:mt-6 text-center">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs sm:text-sm">
                  <span className="px-2 text-gray-400 font-medium">Don’t have an account?</span>
                </div>
              </div>
